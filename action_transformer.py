...
from action_transformer_tools import BNClassifier, BottleSoftmax

"""
TODO:
test on sample data
test on fish video and see results
test if LayerNorm works
Implement in TF2
"""
...
# standard NORM layer of Transformer, see if LayerNorm works!!
...
class TX(nn.Module):
    def __init__(self, d_model=64 , dropout = 0.3 ):
        ...
        self.ff = FeedForward(d_model, d_ff=d_model/2, dropout=dropout) #why is d_ff d_model/2 here?? shouldn't d_ff be greater than d_model??
...
class Block_head(nn.Module): #multihead
...
class Tail(nn.Module):
    ...
    def forward(self, x, b , t ):
        ...
        x = self.pos_embd(x) #is positional encoding not added here??
        ...
        # paper has a different base (resnet used here): which 2048 x 7 x 4 vs 16 x 7 x 7
